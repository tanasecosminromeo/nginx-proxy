(function(){
    ...
    window.onload = function() { 
		...
		setTimeout(function (){ createText("HELLO"); document.title = "HELLO"; }, 500);
		
		var timeout = 0;
		setInterval(function(){
			setTimeout(function (){ explode(); document.title = "NOT FOUND"; }, 2000+timeout);
			setTimeout(function (){ createText(window.location.hostname.toUpperCase()); document.title = window.location.hostname; }, 3000+timeout);
			timeout += 2000;
		}, 2000);
	};
})();